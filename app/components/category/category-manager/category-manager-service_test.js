...
describe("CategoryManager", () => {
    ...
    describe("getCategoriesTree()", () => {
        ...
        it("should create a multilevel tree", () => {
            DS.expectFindAll(Category.name, {sort: [['created_on', 'DESC']], status: 'enabled'}).respond([{"id": "1","source_id": "1","parent_category_id": null},{"id": "4","source_id": "1","parent_category_id": "1"},{"id": "6","source_id": "2","parent_category_id": null},{"id": "2","source_id": "1","parent_category_id": "4"},{"id": "3","source_id": "2","parent_category_id": "6"}]);
